    ...
    <div className="main-content-wrap">
      ...
      <div className="wg-box">
        <div className="flex items-center justify-between gap10 flex-wrap">
          ...
          <a className="tf-button style-1 w208" href="add-brand.html"><i className="icon-plus" />Add new</a>
        </div>
            ...
            <table className="table table-striped table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="pname">
                    <div className="image">
                      <img src="1718066367.html" alt className="image" />
                    </div>
                    <div className="name">
                      <a href="#" className="body-title-2">Brand4</a>
                    </div>
                  </td>
                  <td>brand4</td>
