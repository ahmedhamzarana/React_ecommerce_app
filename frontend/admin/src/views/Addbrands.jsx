          ...
          <div className="wg-box">
            <form className="form-new-product form-style-1" action="#" method="POST" encType="multipart/form-data">
              <fieldset className="name">
                ...
                <input className="flex-grow" type="text" placeholder="Brand name" name="name" tabIndex={0} defaultValue aria-required="true" required />
              </fieldset>
              <fieldset className="name">
                <div className="body-title">Brand Slug <span className="tf-color-1">*</span></div>
                <input className="flex-grow" type="text" placeholder="Brand Slug" name="slug" tabIndex={0} defaultValue aria-required="true" required />
              </fieldset>
              <fieldset>
