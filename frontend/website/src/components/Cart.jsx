...
<main className="pt-90">
  ...
  <section className="shop-checkout container">
    ...
    <div className="checkout-steps">
      ...
      <a href="checkout.html" className="checkout-steps__item">
      ...
      <a href="order-confirmation.html" className="checkout-steps__item">
        ...
        <div className="sticky-content">
          ...
          <div className="mobile_fixed-btn_wrapper">
            <div className="button-wrapper container">
              <a href="checkout.html" className="btn btn-primary btn-checkout">PROCEED TO CHECKOUT</a>
            </div>
          </div>
        </div>
      </div>
